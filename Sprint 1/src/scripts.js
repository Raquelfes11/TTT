...
document.addEventListener("DOMContentLoaded", function () {
    ...
    dniInput.insertAdjacentElement('afterend', dniError);
    ...
    function validateForm() {
        ...
        const isDniValid = dniPattern.test(dni);
        ...
        if (touchedFields.dni && dni && !isDniValid) {
            dniError.textContent = "Invalid DNI format";
        ...
        registerButton.disabled = !(isEmailValid && isDniValid && isAgeValid && isPasswordValid && doPasswordsMatch && areFieldsFilled);
    }
